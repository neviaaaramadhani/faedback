...
SELECT * FROM siswa WHERE hobi = 'Membaca';
...
SELECT * FROM siswa ORDER BY id LIMIT 3;
...
SELECT * FROM siswa WHERE hobi <> 'Sepak Bola';
-- Hitung jumlah siswa yang memiliki hobi 'Menggambar'.
SELECT COUNT(*) AS jumlah_penggambar FROM siswa WHERE hobi = 'Menggambar';